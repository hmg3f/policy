...
* Scheduled Reviews
This policy should be reviewed by the CISO and other parties of interest on a bi-annual basis. New technologies may make the current security controls obsolete in the future, and new business needs may create new information accessibility concerns. Upon updates being made to this enterprise information security policy, any relevant issue-specific and system-specific policies should also be immediately reviewed and updated.

* References
- https://www.mass.gov/doc/is000-enterprise-information-security-policy/download

# Local Variables:
# jinx-local-words: "de facto"
# End:
