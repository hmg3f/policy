...
While it would be ideal to entirely prevent ransomware in an organization, this is often not feasible in practice. An organization needs a plan for dealing with ransomware when an infection occurs. Having a well thought-out plan helps speed up the recovery process, and in some cases makes recovery /possible/ in the first place. Being slow to recover from a ransomware attack can have a massive financial impact on the organization, even if the data is recovered in the end.
...
** Outside
- Gas Pumps
  - Payment and product selection software
  - Sensors and software to detect full tank
- Gasoline
- Gas tanks (underground)
- Air Compressor
- Oil
- Propane Tanks
- Trash Cans
...
- Point of Sale
  - Passkey/username authentication
  - Requires passkey change every 6 months
- Credit Card readers and machines
  - Processed through Verifone
- Age Restricted goods
  - Lottery ticket system
- goods and items in back stock
- Office
- Commander and servers
- backup servers
- Main PC
- CCTV Cameras
  - 20 cameras in total
...
- DVR hardware/software
  - 6 months of on-site backup footage
  - Remote viewing is possible in close proximity
- Mobile application (Modisoft)
- Network
** Business partners
- Gasoline distributor
- Distributor for store goods
- Distributor for car cleaning supplies
- Contractor for mobile application
- Contractor for network design
- Employees
  
* Sources
1. Connolly, L. Y., & Borrion, H. (2020, December). Your Money or Your Business: Decision-Making Processes in Ransomware Attacks. /In ICIS/.
2. Beaman, C., Barkworth, A., Akande, T. D., Hakak, S., & Khan, M. K. (2021). Ransomware: Recent advances, analysis, challenges and future research directions. /Computers & security, 111, 102490/.
3. Song, J., & Barrera, I. (2021, December 21). Why you should choose NGAC as your access control model. /The New Stack/. https://thenewstack.io/why-you-should-choose-ngac-as-your-access-control-model/

# Local Variables:
# jinx-local-words: "Akande Barkworth Beaman Borrion Hakak Maksimik Semir al et"
# End:
